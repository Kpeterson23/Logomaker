  ...
  inquirer
    .prompt([
      ...
      },
      {
        type: "input",
        message:
          "Enter text color either as color keyword or hexadecimal number",
        name: "textColor",
      },
      {
        type: "list",
      ...
      },
      {
        type: "input",
        message:
          "Enter the shape's color of your choice, input value should be : color keyword or hexadecimal number",
        name: "shapeColor",
      },
    ])
    .then((promptAnswer) => {
      ...
      if (promptAnswer.logoName.length > 3) {
        console.log(
          "logo name is more than 3 characters, please enter max of 3 characters to generate a logo"
        );
        question();
      } else {
...
function createShape(resp) {
  ...
  switch (shape) {
    ...
    default:
      console.log(
        "Invalid shape type encountered, please select Triangle, Circle, Square from the options"
      );
      question();
      return "";
      break;
